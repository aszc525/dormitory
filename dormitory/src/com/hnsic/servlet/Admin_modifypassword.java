...
public class Admin_modifypassword extends HttpServlet {		//修改密码
			...
			throws ServletException, IOException {
				...
				try{
					if(password.equals(passwordAgain)){
						...
						out.print("<script language='javascript'>alert('二次密码不一致!!');window.location.href='/dormitory/Admin/Admin_modifypassword.jsp';</script>");					
					}
